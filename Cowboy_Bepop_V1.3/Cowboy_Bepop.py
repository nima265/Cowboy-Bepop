...
def mainloop():
  ...
  level=0
  lives=5
  main_font = pygame.font.SysFont("PressStart2P",13) #font 
  ...
  def refresh_window():
   ...
   window.blit(level_label,(10,45))                                   # location of level
   ...
   if lost:
     ...
     esc2_font = pygame.font.SysFont("PressStart2P", 16)
     esc2_label = esc2_font.render("Press Any Key To Back Menu",1,(255,0,0))
     window.blit(esc2_label, (W/2 - esc2_label.get_width()/2,520))
     f = open("save.txt","r")
     high_level = int(f.read())
     f.close()
     if level > high_level : 
       hscore_font = pygame.font.SysFont("PressStart2P", 20)
       hscore_label = hscore_font.render("New High Score : ",1,(255,0,0))
       window.blit(hscore_label , (W/2 - hscore_label.get_width()/2, 450))
       hscore_label = hscore_font.render(str(level),1,(255,0,0))
       window.blit(hscore_label , (W/2 - hscore_label.get_width()/2, 480))
       f = open("save.txt","w")
       f.write(str(level))
       f.close()
     else:
       ...
       window.blit(hscore_label , (W/2 - hscore_label.get_width()/2, 450))  
       hscore_label = hscore_font.render(str(high_level),1,(255,0,0))
       window.blit(hscore_label , (W/2 - hscore_label.get_width()/2, 480))
     time.sleep(1)  
    ...
    for event in pygame.event.get():
      ...
      if event.type == pygame.KEYDOWN:
        if event.key == pygame.K_ESCAPE:
          pause = True
          while pause :
            pause_font = pygame.font.SysFont("PressStart2P",40)
            pause_labale = pause_font.render("PAUSE",1,(255,0,0))
            window.blit(pause_labale,(W/2 - pause_labale.get_width()/2,300))
            pygame.display.update()
            for event in pygame.event.get(): 
              if event.type == pygame.QUIT:
                quit()
...
def main_menu():
 ...
 while run:
   ...
   title_label6 = title_font2.render("Option", 1, (255,255,255))
   ...
   help_label6 = title_font3.render("PAUSE = esc", 1, (255,255,255))
   ...
   option_label1 = title_font2.render("Game Difficulty", 1, (255,255,255))

   
   dif_label1 = title_font2.render("Choice the Game Difficulty", 1, (255,255,255))
   dif_label2 = title_font3.render("Easy", 1, (255,255,255))
   dif_label3 = title_font3.render("Medium", 1, (255,255,255))
   dif_label4 = title_font3.render("Pro", 1, (255,255,255))
   
   x_label = title_font4.render("X", 1, (255,0,0)) 
   ...
   window.blit(title_label5, (W/2 - title_label5.get_width()/2 , 390))
   window.blit(title_label6, (W/2 - title_label6.get_width()/2 , 440))
   pygame.display.update()
      ...
      if event.type == pygame.KEYDOWN:
        ...
        if event.key == pygame.K_h:
          ...
          while Help:
           ...
           window.blit(help_label6, (W/2 - help_label6.get_width()/2 , 350))
        ...
        if event.key == pygame.K_o:
          ...
          while Option :
            window.blit(BC,(0,0))
            window.blit(option_label1, (W/2 - option_label1.get_width()/2 - 120 , 180))
            pygame.display.update()
            for event in pygame.event.get():
             if event.type == pygame.QUIT:
               quit()
             if event.type == pygame.KEYDOWN:
               ...
               if event.key == pygame.K_g:
                 ...
                 while game_dif:
                    window.blit(BC,(0,0))
                    window.blit(dif_label1, (W/2 - dif_label1.get_width()/2 , 150))
                    window.blit(dif_label2, (W/2 - dif_label2.get_width()/2 - 267 , 250))
                    window.blit(dif_label3, (W/2 - dif_label3.get_width()/2 - 247 , 290)) 
                    window.blit(dif_label4, (W/2 - dif_label4.get_width()/2 - 278, 330))
                    if Game_difficulty == 4:
                     window.blit(x_label,(W/2 - x_label.get_width()/2 - 320 , 292))
                    if Game_difficulty == 2:
                     window.blit(x_label,(W/2 - x_label.get_width()/2 - 320 , 252)) 
                    if Game_difficulty == 7:
                     window.blit(x_label,(W/2 - x_label.get_width()/2 - 320 , 332)) 
                    pygame.display.update()
                    for event in pygame.event.get():
                      if event.type == pygame.QUIT:
                        quit()
